...
namespace MenschenDataForm
{
    public class clsLicenseKlassen
    {
        ...
        public DateTime StandardGültigkeit { get; set; }
        ...
        public clsLicenseKlassen()
        {
            ...
            this.MidestAlter = 18;
            this.StandardGültigkeit = DateTime.Now.AddYears(10);
        ...
        private clsLicenseKlassen(int LicenseKlasseID, string LicenseKlasseName, string LicenseKlasseBeschreibung,
                                 byte MindestAlter , DateTime StandardGültigkeit,float KlasseGebühren)
        {
        ...
        {
            string LicenseKlasseName = ""; string LicenseKlasseBeschreibung = ""; byte MindestAlter = 18;
            DateTime StandardGültigkeit = DateTime.Now.AddYears(10); float KlasseGebühren = 0;
