...
namespace Führerschein
{
    public partial class frmAnmeldung : Form
    {
        ...
        private void frmAnmeldung_Load(object sender, EventArgs e)
        {
            ...
            if (DatenSpeichernInWindowsRegistry.LoadLoginInfoFromWidowsRegistry(ref BenutzerName, ref Password))
            {
                txtbBenutzerName.Text = BenutzerName;
                txtbPassword.Text = Password;
                chbRememberMe.Checked = true;
        ...
        private void btnAnmelden_Click(object sender, EventArgs e)
        {
            ...
            if (Benutzer != null)
            {
                if (chbRememberMe.Checked)
                {
                    ...
                    DatenSpeichernInWindowsRegistry.RememberUserName_PasswordUsingRegistry(txtbBenutzerName.Text.Trim(),
                                                               txtbPassword.Text.Trim(), true);
                }
                else
                    //clsGlobaleKlasse.WriteDataToFile(txtbBenutzerName.Text, txtbPassword.Text, false);
                    DatenSpeichernInWindowsRegistry.RememberUserName_PasswordUsingRegistry(txtbBenutzerName.Text.Trim(),
                                                             txtbPassword.Text.Trim(), false);
